...
<div class="container-fluid">
		<div class="row1">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 her">
		
					<h1 class="titre"><strong>ESCALADE<br>FORMULAIRE</strong></h1>
...
<form action="validationform.php" method="post" enctype="application/x-www-form-urlencoded" name="formulaire">
<tr>
